...
@Composable
fun SplitRectangleScreenM(modifier: Modifier = Modifier, resources: List<Resources>, visible : Boolean, onDismiss: () -> Unit) {
    if(visible) {
...
@Composable
fun ImprovementItemM(modifier: Modifier = Modifier, resource: Resources) {
    Row(
        modifier = modifier.fillMaxWidth(),
...
@Composable
fun RightPartM(modifier: Modifier = Modifier, resource: Resources){
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(start = 40.dp),
